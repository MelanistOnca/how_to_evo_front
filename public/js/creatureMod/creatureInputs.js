...
const creatureInputs = function (genealogy ,compatibleBreed ,size ,power ,move ,energyF ,mutate = 2) {
  // console.log(genealogy ,compatibleBreed ,size ,power ,move ,energyF ,mutate , 'was genealogy ,compatibleBreed ,size ,power ,move ,energyF ,mutate in creatureInputs() of creatureInputs.js');
  ...
  // console.log(engine.world,'was this.props.engine.world in creatureInputs.js');
